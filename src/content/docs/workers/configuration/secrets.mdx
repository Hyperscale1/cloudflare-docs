...
If using [split deployments](/workers/configuration/versions-and-deployments/split-deployments/), instead use the `wrangler versions secret put` command. This will only create a new version of the Worker, that can then be deploying using [`wrangler versions deploy`](/workers/wrangler/commands/general/#versions-deploy).
...
If using [split deployments](/workers/configuration/versions-and-deployments/split-deployments/), instead use the `wrangler versions secret delete` command. This will only create a new version of the Worker, that can then be deploying using [`wrangler versions deploy`](/workers/wrangler/commands/general/#versions-deploy).
